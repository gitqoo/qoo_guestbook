...
foreach ($messages as $row)
{
	...
	if($is_admin)
	{
		echo '<a href="/guestbook/admin/edit.php?id='.$row['id'].'"><img src="./img/edit.png" width="12" height="12" alt="e"/></a>';
		echo '<a href="/guestbook/admin/delete.php?id='.$row['id'].'"><img src="./img/delete.png" width="12" height="12" alt="x"/></a>';
	}
	echo '<br/><b>Message</b>: '.$row['msg'];
	if($row['answer'] != '') echo '<br/><b>Answer</b>: '.$row['answer'];
	if($is_admin) echo '<a href="/guestbook/admin/answer.php?id='.$row['id'].'"><img src="./img/answer.png" alt="answer" width="12" height="12"/></a>';
	echo '</div>';
}
if($posts == 0)
{
...
if($is_admin) 
{
	echo '<div class="msg"><a href="/guestbook/logout.php">Logout</a></div>';
}
else
{
	echo '<div class="msg"><a href="/guestbook/login.php">Sign in</a></div>';
}
?>
